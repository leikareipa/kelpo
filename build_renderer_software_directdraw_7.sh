# Build shiet's software w/ DirectDraw 7 renderer for Win32 using TDM-GCC (MinGW) 4.4.1 via Wine from Linux.
# Unlike the rest of shiet, which is C89, the DirectX 7 headers require compilation with C++.

OUTPUT_FILE="bin/shiet_renderer_software_directdraw_7.dll"
...
src/shiet_renderer/rasterizer/software/rasterizer_software_directdraw_7.c
src/shiet_renderer/surface/software/surface_software_directdraw_7_win32.c
