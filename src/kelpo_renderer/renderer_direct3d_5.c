...
{
    kelpo_surface_direct3d_5__create_surface(windowWidth, windowHeight, bpp, vsyncEnabled, deviceID);
...
void import_renderer(struct kelpo_interface_s *const interface)
{
    ...
    interface->rasterizer.purge_textures = kelpo_rasterizer_direct3d_5__purge_textures;
