...
static const char RENDERER_NAME[] = "OpenGL 1.1";
...
{
    if (!kelpo_window__create_window(screenWidth, screenHeight, RENDERER_NAME, kelpo_surface_opengl_1_1__window_message_handler))
    {
        goto initialization_failed;
    }

    if (!kelpo_surface_opengl_1_1__create_surface(screenWidth, screenHeight, screenBPP, 1, deviceId))
    {
        kelpo_surface_opengl_1_1__release_surface();
        goto initialization_failed;
    }

    if (!kelpo_rasterizer_opengl_1_1__initialize())
    {
        kelpo_rasterizer_opengl_1_1__release();
        kelpo_surface_opengl_1_1__release_surface();
        goto initialization_failed;
    }
...
{
    return (kelpo_surface_opengl_1_1__release_surface() &
            kelpo_rasterizer_opengl_1_1__release() &
            kelpo_window__release_window());
}
                     ...
                     const unsigned interfaceVersion)
{
    ...
    interface->window.flip_surface = kelpo_surface_opengl_1_1__flip_surface;
    ...
    interface->rasterizer.clear_frame = kelpo_rasterizer_opengl_1_1__clear_frame;
    interface->rasterizer.draw_triangles = kelpo_rasterizer_opengl_1_1__draw_triangles;
    interface->rasterizer.upload_texture = kelpo_rasterizer_opengl_1_1__upload_texture;
    interface->rasterizer.update_texture = kelpo_rasterizer_opengl_1_1__update_texture;
    interface->rasterizer.unload_textures = kelpo_rasterizer_opengl_1_1__unload_textures;
