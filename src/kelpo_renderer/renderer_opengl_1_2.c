...
{
    if (!kelpo_window__create_window(screenWidth, screenHeight, RENDERER_NAME, kelpo_surface_opengl_1_2__window_message_handler))
    {
        goto initialization_failed;
    }

    if (!kelpo_surface_opengl_1_2__create_surface(screenWidth, screenHeight, screenBPP, 1, deviceId))
    {
        kelpo_surface_opengl_1_2__release_surface();
        goto initialization_failed;
    }

    if (!kelpo_rasterizer_opengl_1_2__initialize())
    {
