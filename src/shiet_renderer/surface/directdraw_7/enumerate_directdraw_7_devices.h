...
#ifndef SHIET_RENDERER_SURFACE_DIRECTDRAW_7_ENUMERATE_DIRECTDRAW_7_DEVICES_H
#define SHIET_RENDERER_SURFACE_DIRECTDRAW_7_ENUMERATE_DIRECTDRAW_7_DEVICES_H
